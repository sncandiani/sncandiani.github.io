...
// Created my own functions to load web pages instead 
function portfolioItem1ContentLoadOnClick() {
    $('.ajax-portfolio1').on('click', function (e) { 
        e.preventDefault();
        window.location.href = 'https://github.com/nss-day-cohort-38/react-nutshell-blue-bacon-frogs';
    })
}
function portfolioItem2ContentLoadOnClick() {
    $('.ajax-portfolio1').on('click', function (e) { 
        e.preventDefault();
        window.location.href = 'https://github.com/nss-day-cohort-38/nutshell-modest-milky-way';
    })
}
function portfolioItem3ContentLoadOnClick() {
    $('.ajax-portfolio1').on('click', function (e) { 
        e.preventDefault();
        window.location.href = 'https://github.com/sncandiani/Perennial';
    })
}
